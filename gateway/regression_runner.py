"""Regression runner for Shadow Evaluation (t-084).
...
Usage:
    ...
    python gateway/regression_runner.py --model lead-sonnet --dry-run --max-n 2
    python gateway/regression_runner.py --model lead-sonnet --set gateway/regression_set_coding.jsonl
...
def build_payload(model: str, prompt: str, category: str = None) -> dict:
    ...
    heuristic for regression-set traffic (t-085).
    """
