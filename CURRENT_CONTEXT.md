...
~13:40 по ролловой квоте судьи (сегодня 15/20); прокси СЕССИОННЫЙ
фон НЕ переживает простоя (умер тихо между ходами 14:37-16:02,
урок: поднимать заново перед прогоном); наблюдать C3 (рост
unjudged, сцепка F-40); judge_pair без max_tokens + статусные
ходы — калибровка ~07-18.
