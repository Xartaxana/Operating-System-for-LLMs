...
- ТУЛКИТ: ПОРТ-БАТЧ ИСПОЛНЕН И РЕЛИЗ v0.2.0 ВЫШЕЛ 2026-07-14 (слово
  ...
  ОТКРЫТЫ 2 вердикта оператора по плечу A: T1 интерпретация
  (immediate-execution 2+2×2=8, прецедент №1) и T2 предъявка чата
  (отчёт остался в сессии). Окно экзамена (18:53..19:14 UTC, замер
