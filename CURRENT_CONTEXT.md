...
- D-ПРОГОНЫ ГОТОВЫ К ЗАПУСКУ: план и ключи запинованы
  (docs/tasks/2026-07-21_economy-exam-Darm-plan.md: (а) $/принятую
  <= C того же прогона; (б) качество >= 0.87; (в) wall-clock <= 18
  мин; медианы 3 прогонов, смета $15-30). ЖДЁТ: подпись R5 + слово
  оператора на запуск (одним словом, CURRENT_CONTEXT «ЗАВТРА»).
