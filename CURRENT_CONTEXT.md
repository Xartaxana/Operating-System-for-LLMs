...
- ТУЛКИТ: ПОРТ-БАТЧ ИСПОЛНЕН И РЕЛИЗ v0.2.0 ВЫШЕЛ 2026-07-14 (слово
  ...
  БЕЗ дизайнера (в составе — первые reject-ретраи экзамена;
  релизный налог vs шум разделит только повтор, норма протокола
  «медиана 2–3»). На разбор калибровки ~07-18 также: ПОПРАВКА
  ...
  параллельности окна; класс «результат в чате» повторился и у
