...
- ТУЛКИТ: РЕЛИЗ v0.4.0 ВЫШЕЛ 07-20 (публичный d139f3a + тег;
  ...
  (по слову, мораторий в силе): 1) permission_audit
  CLAUDE_PROJECTS-фолбэк (NB-4 критика); 2) порт
  GATEWAY_LOG_RAW_TEXT в ШТАБНОЙ gateway (тот же класс, находка
  батча B); 3) маскирование колонки error — пересмотр словом.
