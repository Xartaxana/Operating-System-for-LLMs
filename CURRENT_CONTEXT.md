...
- ЭКЗАМЕН ЭКОНОМИИ — СЕРИЯ №1–№4 ЗАКРЫТА, ВСЕ РЕШЕНИЯ ПРИНЯТЫ 07-15
  ...
  калибровке.
- НАБОР №2 — ПИНОВКА В РАБОТЕ 07-15 (слово оператора ~16:35
  «составляй набор, экзамен до калибровки»): «ТРЕКЕР РАСХОДОВ ИЗ
  LEGACY-ПРОТОТИПА», 4 сессии × 3 плеча, Sonnet-координатор, табель
  6б. ПИН-ДОК ГОТОВ: docs/tasks/2026-07-15_economy-exam-set2.md
  (тексты S1–S4, дефекты прототипа П1–П10, ловушки CSV, батарея оси
  A 25 проб, чек-лист оси B 12 пунктов, решения пиновки: протез —
  всем плечам, порядок плеч, одиночный прогон с пометкой). В РАБОТЕ:
  t-131 фикстура (builder, docs/exam_fixtures/set2/**), t-132 фича
  раннера sessions (builder + critic). Дальше: приёмка → смета →
  слово оператора → прогон 07-16..17 → разбор к калибровке ~07-18.
