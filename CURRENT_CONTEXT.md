...
- **НАХОДКИ КАЛИБРОВКИ №6 (08-05) — ОЧЕРЕДЬ, все решения записаны:**
  ...
  ОТДЕЛЬНО находка №2 (owns — ПРЕДМЕТ обсуждения в read-only
  диспатче) — ТРЕТИЙ рецидив 08-05 на критик-гейте батча: слово
  «owns» встречается в тексте как тема ревью, путей нет вовсе,
  пишущих индикаторов нет — warn о слепоте формально честен, но
  бесполезен. Многострочный фикс №1 этот подкласс НЕ закрывает по
  построению. Порог ≥3 достигнут, решение назрело: не считать
  манифестом owns-маркер в диспатче БЕЗ единого write-индикатора
  (read-only разведка/ревью) — в следующий батч.
