...
- ВАЛИДАЦИОННЫЙ СЛОЙ ЗАКРЫТ ЦЕЛИКОМ 07-22: DAG
  ...
  висячую метку D-0056b → отчеканено D-0089. ОЧЕРЕДЬ КАЛИБРОВКЕ №4:
  аудит решения экзаменатора «T-K3 экзамена №2 аннулирована как баг
  ключа п.1а» (чек 14; две concordant-точки; разбор — CRITIC_EXAM
...
- White Paper — В РЕЖИМЕ ПОПОЛНЕНИЯ (слово оператора 07-20: ревью
  ...
  Kernel-срез был покрыт §6.4 ранее. ОСТАТОК очереди: развёрнутая
  секция policy-as-code (гейты dispatch/dod/main/hygiene как
  код-слой политики), релиз-нарратив v0.4.0, D-0076..84 сводно
  (частично вплетены в 6.5/6.6).
