...
- **НАХОДКИ КАЛИБРОВКИ №6 (08-05) — ОЧЕРЕДЬ, все решения записаны:**
  ...
  (7) **Личная гигиена Lead — второе окно подряд** (2>&1 ×2 своих,
  python -c ×4 самой калибрующей сессии; всего окно: 2>&1 ×10,
  cd/Set-Location ×8, python -c ×7; журнал мимо Edit/Write — 0).
  Решение: расширение скоупа hygiene_gate на cd-префикс и 2>&1
  (warn) — в батч, evidence промоции по D-0063 набран.
