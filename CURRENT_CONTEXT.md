...
- **РЕВЬЮ CODEX 07-24 РАЗОБРАНО 07-28** (триаж Lead —
  ...
  успехом); (в) кит-порт-очередь: wiring_check
  --host-root/--mode + дизайн режимов телеметрии
  (accounting-only/redacted/full-replay/synthetic) для продукта;
  сюда же unknown-by дельта из разбора AO3 выше. Кандидаты №5 и
  отклонения с reopen-триггерами — в триаж-доке.
