...
- КАЛИБРОВКА №4 ИСПОЛНЕНА 07-23 (досрочно, слово «запускай»; полный
  ...
  ОТКРЫТЫ: явное исключение детерминированных скрипт-запусков из
  skip-требования (чек 22, ×12 за окно — очередь Lead), чек-лист
  манифеста диспетчера перед отправкой (чек 23 — утечка кодификации
  D-0073); (4) редизайн канала
