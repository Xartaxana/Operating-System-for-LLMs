...
- СЮРВЕЙ №2 + СКАМЕЙКА ВОЛНЫ-2 (слово оператора 07-21 «гоняй
  скамейку новых кандидатов параллельно D-прогонам»): сюрвей t-240
  принят (RELATED_WORK «Router candidates survey №2»; RouteLLM
  mf/sw_ranking — не кандидаты); скамейка t-242 В РАБОТЕ (фон):
  (а) aurelio semantic-router, (б) KNN/SVM на наших ярлыках,
  (в) Arch-Router-1.5B zero-shot (лицензия research — оговорка
  оси 7); LOO-дисциплина для (а)/(б) в спеке; ключ misroute<=5%.
