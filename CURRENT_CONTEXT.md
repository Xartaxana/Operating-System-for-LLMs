...
- CLAUDE.md DEEP DIET ЗАВЕРШЁН 07-19 (D-0084, ядро EN; закрытый
  ...
  чека); пустые финал-сообщения воркеров ~200K+ токенов (закрывается
  пунктом 1 «СЛЕДУЮЩЕЙ СЕССИИ» выше); синтетика окон №15–№17
  (D-0075); не-блокеры критика t-208 (глоб → слаг репо; multi-tier
  model).
...
- ПРИВЯЗКИ API-КОНТУРА: D-0085 УТВЕРЖДЕНО 07-20 (вариант A — зеркало
  ...
  (ось 4/7 D-0085); ОНБОРДИНГ-ЭКЗАМЕН API-КОНТУРА ОСТАЁТСЯ (слово
