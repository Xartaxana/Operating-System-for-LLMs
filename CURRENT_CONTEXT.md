...
BOOT-БЮДЖЕТ: раунды 5–8 — 07-13/14; раунд 9 — 07-14 вечер. ПРОБОЙ
113.3К (рост — CURRENT_CONTEXT, экзаменационная неделя) — раунд 10
СОЗНАТЕЛЬНО ОТЛОЖЕН словом оператора 07-15 («пока не делай бут
диету, сначала закроем всё по экзамену — тогда большой кусок
заархивируется разом»): BREACH-строка хука до закрытия экзаменной
ветки — не пропуск скилла. Резерв при новом росте — ROADMAP 17.3К,
отдельным предложением Lead+Architect.
