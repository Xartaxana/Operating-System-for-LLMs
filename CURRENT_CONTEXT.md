...
- ТУЛКИТ: релиз v0.3.0 ВЫШЕЛ 07-16 вечером (снимок 1a6bfe5, тег
  ...
  (дефолт — решение оператора); п.15 permission-audit (после
  проживания в корне); хвост п.18 (порядок boot-diet в свежей
  сессии — сверить при следующем касании session_context кита).
