...
- D-ПРОГОНЫ ИСПОЛНЕНЫ 2026-07-21 (серия №1–№3 + грейдинги
  ...
  задача гейта по D-0086 исполнена той же серией; СЛЕДУЮЩИЙ ШАГ
  workstream: adopt/reject конструкции записью DECISIONS (шаг 4
  плана оценки) — по итогам большого экзамена гибрида H+C
  (пин 2026-07-21_hybrid-exam-set2H-pin.md; плечо H В ПРОГОНЕ на
  момент подписи). Содержательный
