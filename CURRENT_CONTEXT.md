...
3. ПРОГОН №11: малый экзамен (набор №1) с обновлённой основой
   ...
   К первому прогону/сессии с гейтами: живой смок main_gate
   (допущение «Stop без agent_id = main» — PLAUSIBLE по бандлу, не
   смочено живым Stop; не-блокер критика t-159) + file_path-контракт
   dod_track live (builder-оговорка «по аналогии»).
