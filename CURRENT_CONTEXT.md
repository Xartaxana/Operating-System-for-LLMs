...
- ТУЛКИТ: ПОРТ-БАТЧ ИСПОЛНЕН И РЕЛИЗ v0.2.0 ВЫШЕЛ 2026-07-14 (слово
  ...
  2–3). Кандидат-правило с прецедента B0-t3: «builder не пишет в
  owns-пути после сдачи отчёта» (version race, три вердикта критика,
  арбитраж Lead). На разбор калибровки ~07-18 также: ПОПРАВКА
  ...
  фабрика AO3 — 38 ходов); класс «результат в чате» повторился и у
