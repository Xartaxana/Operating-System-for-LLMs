...
вердиктом (см. журнал/Runs log). ШТАТНЫЙ подтверждающий прогон
golden set из свежей сессии по-прежнему полезен как контроль F-34
(правка формы контроля в scout.md сделана in-session — кэш
определений, п.2а). СЛЕДУЮЩАЯ СЕССИЯ: стадия 5б — установка в
