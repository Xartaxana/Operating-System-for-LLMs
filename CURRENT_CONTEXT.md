...
- **КРОСС-ПУНКТ AO3 2026-07-31 (D-0082): порт ветки (д) в
  ...
  441d322 (код+тесты), 6f97508 (их CLAUDE.md). Смежный открытый класс —
  их bugs/AT-BUG-034.md (признак «review-раунд»: ревьюер входит повторно
  при rejected ДРУГОГО агента после нового delegated исполнителя —
  кандидат и для нашего правила 9 при следующем касании). Решения нет.
