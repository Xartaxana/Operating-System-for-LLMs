...
снятие pre-release = стадия 6. NB: лицензия отгружена как MIT
(В4 «да» без текста — рабочий дефолт); если оператор хочет иную —
заменить в шаблоне до раздачи. ПРИОРИТЕТ ОПЕРАТОРА
