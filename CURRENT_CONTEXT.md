...
3. ПРОГОН №11: малый экзамен (набор №1) с обновлённой основой
   ...
   НАХОДКА о гейте (чек 26в) на калибровку ~07-18: dotfiles-конфиги
   без суффикса (.gitignore, .gitattributes) падают в fail-closed —
   кандидат расширения doc-only ЛИБО «не чинить» (цена блока — один
   узкий прогон ~3с; Rule #1 может сказать оставить).
