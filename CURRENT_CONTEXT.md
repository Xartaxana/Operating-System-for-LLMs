...
- ТУЛКИТ: ПОРТ-БАТЧ ИСПОЛНЕН И РЕЛИЗ v0.2.0 ВЫШЕЛ 2026-07-14 (слово
  ...
  прогона ~07-18); п.10 экзамен экономии — прогон №2 ВЫПОЛНЕН 07-14
  вечером, строка Runs log внесена (чек 14е закрыт для v0.2.0);
  итоги и разбор — docs/tasks/2026-07-14_economy-exam-run2.md.
  A-T2 ПРИНЯТ по предъявке чата (5/5 новых утверждений сверены);
  ОТКРЫТ 1 вердикт оператора: A-T1 интерпретация
  (immediate-execution 2+2×2=8, прецедент №1 — C-T1). Окно экзамена (18:53..19:14 UTC, замер
  cc_usage) — в notes калибровки ~07-18 (D-0075, тренды 11/18 без
  exam_release2); п.13
