...
onboarding не собирает оси симметрии принимающего проекта; фикс —
шаг onboarding «вопрос оператору + опциональный scout-обзор», в
батч находок 5б, полный rule-10 при коммите фикса). Сразу ПОСЛЕ
