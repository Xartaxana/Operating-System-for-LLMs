...
- ПОДТВЕРЖДАЮЩИЙ ШТАТНЫЙ прогон golden set scout — ПЕРВЫМ ДЕЛОМ
  следующей сессии (свежий харнесс читает суженный тулсет с диска;
  прогон t-327 07-28 шёл метод-девиацией п.2а — inline-запрет Bash
  на закэшированном определении, PASS 7/7 условен методом).
...
- ОЧЕРЕДЬ КАЛИБРОВКИ №5 (~07-30, консолидирована диетой 07-24):
  ...
  изъят у нас 07-28 по P0 внешнего ревью).
