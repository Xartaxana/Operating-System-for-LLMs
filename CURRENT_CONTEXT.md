...
- ГЭП-БАТЧ ВАЛИДАЦИИ 07-23 В РАБОТЕ (слово «закрывай все пункты»; DAG
  docs/tasks/2026-07-23_validation-gaps.md, t-298..t-303 + critic):
  wiring-autofix, judge-prompt-pin, negative_lint (промоция D-0063 —
  рецидив t-296 ПОСЛЕ закрытия дисциплиной D-0094), witness↔трек,
  hygiene-блок журнального класса, parity_check. ОЧЕРЕДЬ из батча:
  ...
  Регистрация negative_lint в .claude/settings.json ОТКЛОНЕНА
  оператором на постановке — активация только его словом.
