...
- ПУНКТ 2 — ИСПОЛНЕН 2026-07-21 (t-236, ~$0.04): causal_llm
  ...
  bert; ties 7/20 на экзамен-срезе). ВСЕ ТРИ роутер-кандидата
  закрыты → D-плечо только со статикой (кандидат №1), резерва нет —
  строка в гейт-отчёт. Вердикты VERBATIM — план оценки
...
- CLAUDE.md DEEP DIET ЗАВЕРШЁН 07-19 (D-0084, ядро EN; закрытый
  ...
  (глоб → слаг репо; multi-tier model). Пункт «пустые
  финал-сообщения воркеров» закрыт 07-21 механизмом F-49 (чек 29).
