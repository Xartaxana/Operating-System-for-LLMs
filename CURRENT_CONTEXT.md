...
крупнейший кусок, порядок стройки 1–7). ОТКРЫТО У ОПЕРАТОРА: подтверждение MIT (В4 «да» без текста
лицензии). Phase 1/1.5 ЗАКРЫТЫ 2026-07-11 (подпись оператора «да
закрывай», блок в ROADMAP). Прочие нити: вторая калибровка ~07-18;
