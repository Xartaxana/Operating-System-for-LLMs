...
- ТУЛКИТ: ПОРТ-БАТЧ ИСПОЛНЕН И РЕЛИЗ v0.2.0 ВЫШЕЛ 2026-07-14 (слово
  ...
  прогона ~07-18); п.10 экзамен экономии — прогон №2 ЗАПУЩЕН 07-14
  вечером (слово оператора; лист docs/tasks/2026-07-14_economy-exam-run2.md,
  вариация: opus-спеки в плече B, конфаунд релиз+дизайнер помечен;
  полигон exam_release2 — t-110; строка Runs log — по итогам, чек
  14е); п.13
  privacy-режимы (дефолт — решение оператора); п.15
  permission-audit (t-107) — после проживания в корне. Мораторий
