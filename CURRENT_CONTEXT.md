...
- D-ПРОГОНЫ ИСПОЛНЕНЫ 2026-07-21 (серия №1–№3 + грейдинги
  ...
  РАЗВИЛКА АРХИТЕКТОРУ: (i) подтверждающая мини-серия с
  параллельным лаунчем (~$10-15, только лаунчер меняется) — честное
  закрытие (в); (ii) принять атрибуцию «сплит = артефакт» словом —
  гейт открывается сейчас; (iii) оставить (в) красным — гейт
  закрыт. Содержательный итог серии: судейский гейт трижды купил
  корректность t1 (=6 против =8 у C во всех прогонах), лестница
  стабильна, C терял evidence; находки — галлюцинация судьи
