...
существующий проект оператор выполняет САМ (слово оператора
2026-07-12 «я сама поставлю, так будет реалистичнее» — аналог
протокола незнакомца 5а, вторая реалистичная точка). Вход выдан:
github.com/Xartaxana/Supervised-Delegation, INSTALL.md Path B +
onboarding-скилл. Lead в установку НЕ вмешивается; приёмка за Lead
(D-0037) по отчёту оператора, критерии: (1) Path B на существующем
проекте, (2) onboarding пройден — привязка моделей + вступительные
экзамены, (3) первый делегированный цикл в их журнале, (4) список
находок/спотыканий и отступлений от INSTALL.md — дословно, как в 5а.
