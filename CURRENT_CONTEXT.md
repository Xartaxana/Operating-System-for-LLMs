...
ОСТАЛОСЬ:
честный повтор прогона A (middle-oss + judge-gemini) — 2026-07-14
~13:40 по ролловой квоте судьи; наблюдать C3 (рост unjudged, сцепка
F-40); judge_pair без max_tokens + статусные ходы — калибровка
~07-18. Поправка 16:1x (класс F-30) — архивирована в отчёт дня.
