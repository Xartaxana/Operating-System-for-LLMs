...
- ТУЛКИТ: ПОРТ-БАТЧ ИСПОЛНЕН И РЕЛИЗ v0.2.0 ВЫШЕЛ 2026-07-14 (слово
  ...
  2–3). Правило «отчёт — финальная сдача, недоделанное не сдаётся»
  ВНЕДРЕНО в корне словом оператора 07-14 (~23:55): builder.md п.7
  (прецедент version race B0-t3). ОЧЕРЕДИ класса (оси 1/3/6):
