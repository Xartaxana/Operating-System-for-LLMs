...
- D-ПРОГОНЫ ЗАПУЩЕНЫ 2026-07-21 (слово оператора выше): план и
  ключи — docs/tasks/2026-07-21_economy-exam-Darm-plan.md ((а)
  $/принятую <= C того же прогона; (б) качество >= 0.87; (в)
  wall-clock <= 18 мин; медианы 3 прогонов, смета $15-30); DAG
  задачи — там же; синтетика окон прогонов — пометка D-0075
  калибровке №4.
