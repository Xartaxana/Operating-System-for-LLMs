...
ДЕЛОМ следующей сессии; AO3-порт (их scout-правила 3+4 + гигиена)
— на следующем касании их ролевых файлов. (2) РЕЛИЗНЫЙ ПУШ
Supervised-Delegation ждёт явного слова оператора (клон готов в
scratchpad; в пуше: ссылка на репо разработки, фиксы t-058,
scout/гигиена-ужесточения). (3) Неиспользованный полигон
