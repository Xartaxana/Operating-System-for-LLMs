...
- Экзамены №12–№14: скаляры 0.95; critic-lite −37% → порт в штаб
  ...
  evening-run-series.
КАЛИБРОВКА №3 ЗАКРЫТА 07-19 (внеплановая, ~1.1 дн окна; notes
calibrated 07-19T14:11 — полный разбор там): находка F-48 (4
кросс-деплойных пункта испарились — восстановлены в AO3 HANDOFF
cb587b4; ПРОМОЦИЯ по второму рецидиву → D-0082 этой сессией 07-19);
рецидив F-47 ремедиирован доприёмкой d951844; движений таблицы нет;
чек 22: батчинг D-0081 подтверждён (1 skip vs baseline 16).
ОЧЕРЕДЬ: №15 — вторая точка critic-lite (№3 её не гоняла — кит не
дрейфовал, чек 14е; точка при №4 ~07-25); экзамен
Sonnet-координатора ждёт естественного батча (D-0080 п.4); Get-Date
в allowlist — решение оператора; опус-дизайнер: 3 точки/0
реджектов — вердикт №4; чек-25-хвосты 07-18: шумная граница
decomposable — кандидат builder.md «возврат после пробы»; owns-пути
в манифестах — АБСОЛЮТНЫМИ. AO3-ОЧЕРЕДЬ живёт в ИХ носителе
docs/HANDOFF.md (D-0082; восстановление cb587b4 + порт-пункт
D-0082 07-19). Следующая калибровка ~07-25.
...
- ТУЛКИТ: релиз v0.3.0 вышел 07-16 (состав батча — VERBATIM
  ...
  чек 3а session-handoff. Мораторий в силе.
