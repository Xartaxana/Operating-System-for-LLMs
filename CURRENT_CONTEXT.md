...
- D-ПРОГОНЫ ИСПОЛНЕНЫ 2026-07-21 (серия №1–№3 + грейдинги
  ...
  (б) 0.975>=0.87; (в) 17.1<=18). ГЕЙТ-СТРОКА ROUTER НА ПОДПИСЬ
  АРХИТЕКТОРА: R1+ (34 пары/5 прогонов), R2'+ (~85% координационных),
  R3+ (формально), R5+ (подписан 07-21), R4'+ (взят сериями D№1–№6)
  — все критерии зелёные, открытие workstream = подпись. Первая
  задача открытого гейта по D-0086 УЖЕ ИСПОЛНЕНА (D-прогоны и есть
  она); следующий шаг — решение adopt/reject конструкции записью
  DECISIONS (шаг 4 плана оценки) + большой экзамен гибрида H+C
  (пин 2026-07-21_hybrid-exam-set2H-pin.md, в работе). Содержательный
...
- ПРИВЯЗКИ API-КОНТУРА: D-0085 УТВЕРЖДЕНО 07-20 (вариант A — зеркало
  ...
  toolkit/tools/dod_gate.py (ось 7); ОНБОРДИНГ-ЭКЗАМЕН API-КОНТУРА ОСТАЁТСЯ (слово
