...
- ПУНКТ 1 СЛЕДУЮЩЕЙ СЕССИИ — ИСПОЛНЕН 2026-07-21: класс F-49
  ...
  кит — порт-очередь.
- ПУНКТ 2 — В РАБОТЕ (t-236, фон): скамейка роутер-кандидатов №2
  (causal_llm 8B, CPU-оффлайн) и №3 (haiku-классификатор, synthetic
  через прокси) на стенде labeled_v2 (песочница routellm_smoke,
  scratchpad сессии f4eec97c) тем же AUC-протоколом; bert-baseline
  0.6224/0.6000 (отклонён 20259ff); вердикты — в план оценки
