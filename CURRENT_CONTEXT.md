...
- НАБОР №3 = ДИЕТ-B, ИТЕРАЦИИ 1–2 ЗАКРЫТЫ 07-16 (прогоны №7/№8/№9;
  ...
  весь policy-as-code стек жив и доказал себя измерителем (форензика
  №9 доказательна по артефактам). ОЧЕРЕДЬ policy-as-code: кандидат
  Stop(main)-гейт — координатор правит деливерабл сам мимо
  SubagentStop (русло №9-t3); порт гейтов в штаб/тулкит — после
  решения оператора по составу. Большой прогон — по каденции.
