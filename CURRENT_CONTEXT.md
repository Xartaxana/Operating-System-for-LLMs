...
- НАБОР №3 = ДИЕТ-B (слово 07-16): дизайн —
  docs/tasks/2026-07-16_diet-b-design.md; ПРОГОН №7 (малый, Bfull
  vs Bdiet vs C, набор №1, Sonnet) ЗАПУЩЕН 07-16 ~02:13 (t-142,
  полигон exam_run7_set1_diet; kit'ы 2560d2b/70cbd59, манифест в
  docs/tasks/). После него: грейдинг рубрикой набора №1 + сравнение
  ходов/цены. Большой диет-прогон — по каденции (релиз/слово).
  РЕЗЕРВ — генератор статического сайта из markdown.
