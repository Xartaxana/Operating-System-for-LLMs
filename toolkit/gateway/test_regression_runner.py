"""Tests for regression_runner.py.

No live proxy required: urllib.request.urlopen is mocked throughout.

Run: python -m pytest toolkit/gateway/test_regression_runner.py
"""
...
def test_payload_structure(tmp_path):
    ...
    # ground-truth category from the regression set row reaches the payload
