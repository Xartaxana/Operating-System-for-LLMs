...
PRICES_PER_TOKEN_USD = {
    ...
    # t-343 (батч 2 находок калибровки №5, ось 2 "новая модель -> оба
    # учёта, никогда молчаливый $0"): окно 6213 ходов claude-opus-5 шло
    # с WARNING unknown model / cost=None. Официальный прайс идентичен
    # claude-opus-4-8 ($5/M input, $25/M output) -- источник:
    # прайс-справочник 2026-07-29, калибровка №5. Значения СКОПИРОВАНЫ
    # байт-в-байт со строки claude-opus-4-8 выше (тот же
    # CACHE_WRITE_MULTIPLIER/CACHE_READ_MULTIPLIER применяются к обеим
    # моделям одинаково, отдельного множителя не требуется).
